      ...
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["Tenant", "Members", "status", "Staying Data", "Amount", ""].map((el) => (
                  <th
                    key={el}
            ...
            <tbody>
              {tenantTableData.map(
                ({ img, name, email, job, online, date, members,budget }, key) => {
                  const className = `py-3 px-5 ${
                    key === tenantTableData.length - 1
                      ? ""
      ...
      {/* <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["Tenant", "function", "status", "employed", ""].map((el) => (
                  <th
                    key={el}
                    className="border-b border-blue-gray-50 py-3 px-5 text-left"
                  >
